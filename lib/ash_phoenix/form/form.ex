...
defmodule AshPhoenix.Form do
  ...
  defp validate_nested_forms(
    ...
    shared_context = shared_context(form.opts[:context])
  ...
  * `:format` - This option is ignored for `raw_errors/2` as it always returns raw errors.
    ...
    new_form =
      for_action(
        ...
        Keyword.merge(opts[:validate_opts] || [],
          ...
          scope: form.opts[:scope],
          tenant: form.opts[:tenant],
          context: shared_context(form.opts[:context]),
  ...
  defp handle_forms(
    ...
    shared_context = shared_context(context)
  ...
  defp shared_context(nil), do: nil
  defp shared_context(context), do: Map.take(context, [:shared])
